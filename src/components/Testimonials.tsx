  ...
  const testimonials = [
    {
      ...
      service: "Индивидуальная консультация. Натальная карта"
    },
    {
      id: 2,
      name: "Юлия",
      ...
      photo: false,
      rating: 5,
      text: "После развода чувствовала себя потерянной. Астрологическая консультация дала мне понимание и направление для нового этапа жизни. Рекомендую всем, кто переживает сложный период.",
      service: "Индивидуальная консультация. Натальная карта"
    },
    {
      id: 3,
      ...
      photo: true,
      rating: 5,
      text: "Удивительно точный анализ! Впечатлил прогноз на год — многие события произошли, а рекомендации помогли справиться с трудностями. Это помогло мне подготовиться и использовать возможности.",
      service: "Прогноз на год"
    },
    {
      id: 4,
      name: "Дмитрий",
      ...
      photo: false,
      rating: 4,
      text: "Астростратегия для бизнеса превзошла все ожидания. Помогла выбрать правильное время для запуска проекта и понять динамику команды. Спасибо!",
