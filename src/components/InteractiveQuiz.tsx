...
const InteractiveQuiz = () => {
  ...
  const getResult = () => {
    ...
    const results = {
      "Огонь": {
        title: "\"Огненная\" Луна",
        description: "Ваша Луна в огненном знаке или сильных аспектах с огненными планетами говорит о страстной натуре и потребности в самовыражении.",
        traits: ["Спонтанность", "Лидерские качества", "Энергичность"],
        advice: "Используйте свою энергию для вдохновения других и реализации амбициозных целей. (Рекомендации на сайте являются обобщёнными. Чтобы получить индивидуальный разбор, запишитесь на консультацию с астрологом.)"
      },
      "Земля": {
        title: "\"Земная\" Луна",
        description: "Ваша Луна в земном знаке или сильных аспектах с земными планетами указывает на практичность и потребность в стабильности.",
        traits: ["Надежность", "Терпеливость", "Практичность"],
        advice: "Доверяйте своей способности создавать прочный фундамент для будущего. (Рекомендации на сайте являются обобщёнными. Чтобы получить индивидуальный разбор, запишитесь на консультацию с астрологом.)"
      },
      "Воздух": {
        title: "\"Воздушная\" Луна",
        description: "Ваша Луна в воздушном знаке или сильных аспектах с воздушными планетами говорит о потребности в общении и интеллектуальной стимуляции.",
        traits: ["Любознательность", "Общительность", "Гибкость"],
        advice: "Развивайте свои коммуникативные способности и делитесь знаниями с окружающими. (Рекомендации на сайте являются обобщёнными. Чтобы получить индивидуальный разбор, запишитесь на консультацию с астрологом.)"
      },
      "Вода": {
        title: "\"Водная\" Луна",
        description: "Ваша Луна в водном знаке или сильных аспектах с водными планетами указывает на высокую эмпатию и интуитивные способности.",
        traits: ["Эмпатия", "Интуиция", "Эмоциональная глубина"],
        advice: "Доверяйте своей интуиции и используйте эмоциональный интеллект как суперсилу. (Рекомендации на сайте являются обобщёнными. Чтобы получить индивидуальный разбор, запишитесь на консультацию с астрологом.)"
      }
    };
