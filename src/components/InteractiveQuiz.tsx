          ...
          <Card className="max-w-2xl mx-auto shadow-mystical bg-card/90 backdrop-blur-sm border-accent/30">
            ...
            <CardContent className="text-center">
              ...
              <div className="bg-accent/10 p-4 rounded-lg mb-6">
                ...
                <p className="text-xs text-muted-foreground opacity-70 italic mb-2">
                   Рекомендации на сайте являются обобщёнными. Чтобы получить индивидуальный разбор, запишитесь на консультацию с астрологом.
                </p>
              </div>
