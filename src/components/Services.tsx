  ...
  const services = [
    {
      ...
      features: ["Анализ характера", "Таланты. Сильные и слабые стороны", "Жизненные задачи"],
    },
    {
      id: 2,
      icon: Heart,
    ...
    },
    {
      ...
      duration: "45 минут",
      category: "Стандартные",
      features: ["Быстрые ответы", "Конкретные решения", "Любой вопрос"],
    },
    {
      id: 5,
      icon: Users,
    ...
    },
    {
      ...
      duration: "90 минут",
      category: "Индивидуальные",
      features: ["Архетип бренда. Миссия", "Целевая аудитория", "Стратегия коммуникации"],
    },
    {
      id: 8,
      icon: Calendar,
    ...
    // Дополнительные индивидуальные услуги
    {
      ...
      duration: "90 минут",
      features: [
        "Подбор дела, спорта, хобби",
        "Индивидуальные рекомендации - Где брать энергию?",
    ...
    },
    {
      ...
      duration: "90 минут",
      features: [
        "Анализ уязвимых зон. Выявление рисков",
        "Профилактические советы, рекомендации",
        "Выявление причинно-следственных связей заболевания",
      ],
    },
    {
      id: 11,
    ...
    },
    {
      ...
      duration: "90 минут",
      features: [
        "Партнерства: личные, деловые, дружеские и другие",
        "Советы по гармонизации ожиданий и реальности",
